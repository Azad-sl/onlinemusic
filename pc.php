    ...
    <div class="container">
        <div class="btn-bar">
            ...
            <div class="btn-box" id="btn-area">
                ...
                <span class="btn" data-action="playing" title="点击回到主页"><a href="http://www.azad.asia/"><span style="color:white">🚪 Home</span></a></span>
                ...
                <span class="btn-area"><input type="button" value="📢" style="width: 25px; height: 25px; border-radius: 50%;border: none;background-color: #bfc4c9;" onclick="alert('建议使用歌曲搜索（暂支持网易、酷狗）。支持下载、外链。              播放列表网易云歌单同步测试中。 版权原因VIP歌曲无法播放下载（自动跳过）。')"/></span>
